package org.raterr.usecases.premieres
...
class PremieresController(
    ...
    private fun getFollowedPremieres(user: org.raterr.usecases.user.User): Triple<List<PremiereItem>, List<PremiereItem>, List<PremiereItem>> {
